    ...
    return (
        <aside className="w-64 bg-slate-800 text-white flex flex-col p-4 shrink-0">
            ...
            <nav className="flex flex-col space-y-2 shrink-0">
                ...
                <NavItem icon={<RoutineIcon />} label="Crea tu Rutina" isActive={currentView === 'routine'} onClick={() => setCurrentView('routine')} />
                <NavItem icon={<ProfileIcon />} label="Perfil" isActive={currentView === 'profile'} onClick={() => setCurrentView('profile')} />
                <NavItem icon={<SettingsIcon />} label="Ajustes" isActive={currentView === 'settings'} onClick={() => setCurrentView('settings')} />
            </nav>
